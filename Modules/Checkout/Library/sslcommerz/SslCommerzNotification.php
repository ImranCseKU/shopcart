<?php
namespace Modules\Checkout\Library\SslCommerz;
...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function __construct()
    {
        $this->config = [
            ...
            'apiCredentials' => [
                'store_id' => 'shops5f0af01d00543',
                'store_password' => 'shops5f0af01d00543@ssl',
            ],
            'apiUrl' => [
    ...
    public function orderValidate($trxID = '', $amount = 0, $currency = "BDT", $requestData)
    {
