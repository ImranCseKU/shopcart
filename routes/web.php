...
Route::post('/success', 'SslCommerzPaymentController@success')->middleware('web');

Route::post('/fail', 'SslCommerzPaymentController@fail')->middleware('web');
Route::post('/cancel', 'SslCommerzPaymentController@cancel')->middleware('web');